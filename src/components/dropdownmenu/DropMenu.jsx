...
import { setcurrentmode, setdrawingtype, setidrawing, setdrawpolystatus } from "../../features/players/firstboardPlayersSlice"
        ...
        <SelectGroup>
          ...
          <SelectLabel>Features</SelectLabel>
          {
            Object.keys(items).map((keyname,i)=>(
              <SelectItem value={keyname} key={i}>{items[keyname]}</SelectItem>
            ))
          }
        </SelectGroup>
      </SelectContent>
